...
import { ensureCheatAccess } from '$lib/server/entitlements';
...
export const GET: RequestHandler = async ({ url, locals }) => {
	...
	if (playerId && character) {
		...
		// Owner + moderator cheat menus need no ADMIN_SECRET — flag it here so
		// the client lists the commands before they've taken a turn.
